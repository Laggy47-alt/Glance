...
import { Bell, BellOff, Camera, X, Archive as ArchiveIcon, MessageSquare, Tag as TagIcon, RotateCcw, Sparkles } from "lucide-react";
...
// Five real ABC org snapshots + clips, mirrored into the public
// `camera-snapshots` bucket so /demo works without authentication.
const STORAGE = "https://bgczubehzofjvjenozof.supabase.co/storage/v1/object/public/camera-snapshots/demo";

const SEED: DemoAlert[] = [
  { key: "demo-1", camera: "maritha_hof_6", site: "ABC · Hagerhof", label: "person",
    ts: "2026-05-08T09:11:35.121Z", score: 0.87,
    snapshotUrl: `${STORAGE}/snap-1.jpg`, clipUrl: `${STORAGE}/clip-1.mp4` },
  { key: "demo-2", camera: "eden_1", site: "ABC · Hagerhof", label: "person",
    ts: "2026-05-08T09:08:55.116Z", score: 0.79,
    snapshotUrl: `${STORAGE}/snap-2.jpg`, clipUrl: `${STORAGE}/clip-2.mp4` },
  { key: "demo-3", camera: "perimeter_5", site: "ABC · Eikenwater", label: "person",
    ts: "2026-05-08T09:07:24.216Z", score: 0.82,
    snapshotUrl: `${STORAGE}/snap-3.jpg`, clipUrl: `${STORAGE}/clip-3.mp4` },
  { key: "demo-4", camera: "3_peeka_front", site: "ABC · Peeka", label: "person",
    ts: "2026-05-08T09:03:32.611Z", score: 0.91,
    snapshotUrl: `${STORAGE}/snap-4.jpg`, clipUrl: `${STORAGE}/clip-4.mp4` },
  { key: "demo-5", camera: "3_peeka_front", site: "ABC · Peeka", label: "person",
    ts: "2026-05-08T09:02:15.882Z", score: 0.76,
    snapshotUrl: `${STORAGE}/snap-5.jpg`, clipUrl: `${STORAGE}/clip-5.mp4` },
];
...
const Demo = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border bg-card/40 backdrop-blur sticky top-0 z-10">
        <div className="px-6 py-3 flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold">Live Wall — Demo</h1>
            <Badge variant="outline" className="ml-1 uppercase tracking-wider">Demo</Badge>
          </div>
          <p className="text-xs text-muted-foreground hidden md:block">
            Idle screen — incoming snapshots pop up here
          </p>
      ...
      <main className="p-4">
        <div className="relative h-[calc(100vh-6rem)] rounded-lg border border-border bg-gradient-to-br from-background via-background to-secondary/30 overflow-hidden">
          {alerts.length === 0 && (
      ...
      {lightbox && (
        ...
        >
          ...
          <div className="max-w-5xl w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <video
              key={lightbox.clipUrl}
              src={lightbox.clipUrl}
              poster={lightbox.snapshotUrl}
              controls
              autoPlay
