      ...
      <Card className="bg-gradient-card border-border shadow-card p-5 mb-5">
        ...
        <div className="flex items-start gap-2 mt-3 p-2 rounded bg-secondary/40 border border-border">
          ...
          <p className="text-xs text-muted-foreground">
            For testing you can use <code className="text-foreground">onboarding@resend.dev</code>. To send from your own domain, verify it in your email provider (Resend) and update the From email above.
          </p>
        </div>
